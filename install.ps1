...
Write-Host "  `$usage-guard status  # compact fallback HUD"
...
Write-Host "Desktop tasks can show the new pixel-art live visualizer automatically; no extra package or API key is required."
