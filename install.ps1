...
Write-Host "Recommended: stay inside Codex and keep your currently selected model."
Write-Host "  `$usage-guard <task>"
Write-Host "  `$usage-guard status"
Write-Host "  `$usage-guard usage"
Write-Host "Usage Guard does not change your model or reasoning mode by default."
Write-Host "Normal Usage Guard use stays inside Codex; no separate visualizer window opens by default."
Write-Host "No extra API key or Ollama is required. It uses your existing Codex sign-in."
Write-Host "Advanced cguard model routing remains available only when you explicitly choose to use it."
